...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `<b>Player<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "Duels  1v1",
      descriptionKey: "Practice your skills in the Duel 1v1 TournamentX! mode!",
    ...
    },
    {
      ...
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "Duels 2v2 ",
      descriptionKey: "Practice your skills in the Duels 2v2 TournamentX! mode!",
