...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `<b><i><color=red>StumbleHard<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      descriptionKey: "Practice your skills in the StumbleHard 1v1 TournamentX! mode!",
    ...
    },
    {
      ...
      descriptionKey: "Practice your skills in the StumbleHard 2v2 TournamentX! mode!",
